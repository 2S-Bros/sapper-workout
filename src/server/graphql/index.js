...
const queries = merge(userResolver, exerciseResolver, resolverMap)
const mutations = merge(userMutations, exerciseMutations)
...
const apolloServer = new ApolloServer({
  context,
  resolvers,
  typeDefs: [commonTypeDef, userTypeDef, exerciseTypeDef]
})
